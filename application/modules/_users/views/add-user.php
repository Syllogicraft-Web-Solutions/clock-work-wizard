...
<form class="enroll-form w3-theme-l3 " method="post" action="<?= base_url($page['module_name'] . '_users/add_user') ?>">
	...
	<div class="enroll-fields-container w3-container">
		...
		<div class="fields w3-row-padding">
			<div class="w3-margin">
				...
				<input class="w3-input w3-border-theme" required type="text" name="username">
			</div>
			<div class="w3-margin">
				<label>Password</label>
				<input class="w3-input w3-border-theme" required type="password" name="password">
			</div>
			<div class="w3-margin">
				<label>Email</label>
				<input class="w3-input w3-border-theme" required type="email" name="email">
			</div>
		</div>
